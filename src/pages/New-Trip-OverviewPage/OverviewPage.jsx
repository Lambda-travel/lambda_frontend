            ...
            <div className="info-user-container">
                <div className="name-and-edit">
                    ...
                    <button className="edit-trip-btn" onClick={toggleEditTrip}>
                        <svg style={{width:"1.2rem"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
               ...
               <div className="categories-btn-container">
                ...
                <div className="places-to-visit-container">
                    <button className="places-to-visit-handler-btn">
                        <svg style={{width:"1.4rem"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
