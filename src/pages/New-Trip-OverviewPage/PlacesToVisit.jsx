    ...
    <article>
      <div className="container-places-to-visit">
        <div className="btn-and-title">
          ...
          <h3 onClick={toggleDetail} className="places-to-visit">
            Places to Visit
          </h3>
        </div>
        <button
          onClick={toggleAdd}
          className={showDetail ? "add-place-to-visit-btn" : "none"}
        >
      ...
      {showDetail ? (
        <div className="description-container">
          ...
          <p className="description-place">
            The Maldive Islands are a series of coral atolls built up from the
            crowns of a submerged ancient volcanic mountain range. All the
            islands are low-lying, none rising to more than 6 feet (1.8 metres)
          </p>
          <div className="container-btn-view-detail-place">
            <Link to="/trip/overview/destination-detail">
              <button className="view-details-places">View Details</button>
            </Link>
          </div>
        </div>
      ) : null}
